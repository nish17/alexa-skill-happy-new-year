...
const SKILL_NAME = 'All In One New year';
const GET_FACT_MESSAGE = "Here's your fact: ";
const HELP_MESSAGE = 'You can say tell me a new year fact, or how much time is remaining for the new year or, you can say exit... What can I help you with?';
...
function getDateAndTime(){
	...
	var now = new Date().getTime();
		...
		if(distance < 0) return `It's already New Year! Happy New Year to all!`;
